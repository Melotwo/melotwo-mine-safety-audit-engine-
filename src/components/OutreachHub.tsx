...
export const OutreachHub: React.FC<OutreachHubProps> = ({ 
  ...
  const [promoCode] = useState<string>('BUILD10');
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-2 max-w-2xl">
              ...
              <p className="text-sm text-slate-300 leading-relaxed">
                Share your unique promo code with fellow contractors and mining site leads. Receive cash payouts directly into your bank account whenever they generate a 20-Section Tender Safety File or enterprise site pack.
              </p>
            </div>
            ...
            <div className="shrink-0 flex md:flex-col items-center md:items-end justify-between gap-2 bg-slate-950/80 border border-slate-800 p-4 rounded-2xl">
              <span className="text-[11px] font-mono text-slate-400 uppercase">Payout Schedule</span>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-800 pb-4">
            ...
            <span className="text-xs text-slate-400">
              Share with colleagues, subcontractors, and tender applicants
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div>
              <span className="text-[10px] font-mono font-bold text-amber-400 uppercase tracking-wider">
                SECTION 2 &bull; PERFORMANCE & BALANCE
              </span>
              <h2 className="text-lg sm:text-xl font-black text-white tracking-tight mt-0.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 relative overflow-hidden shadow-lg hover:border-slate-700 transition">
              ...
              <p className="text-[11px] text-slate-400 mt-2 flex items-center gap-1.5">
                ...
                Cumulative payouts earned to date
              </p>
            </div>
          ...
          <div className="bg-slate-900/90 border border-cyan-500/30 rounded-2xl p-4 sm:p-5 flex items-start gap-3 text-xs text-slate-300">
            ...
            <div className="space-y-1">
              ...
              <p className="text-slate-300 text-xs leading-relaxed">
                <strong className="text-amber-400">R100 instant cash</strong> per standard R750 Tender File &bull; <strong className="text-cyan-300">10%–15%</strong> on custom site packs.
              </p>
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 max-w-lg w-full shadow-2xl space-y-5">
            ...
            <p className="text-xs text-slate-300 leading-relaxed">
              Enter the bank account where your weekly MeloTwo referral rewards should be deposited.
            </p>
